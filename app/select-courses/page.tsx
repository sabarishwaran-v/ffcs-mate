...
function SelectCoursesContent() {
  ...
  const [selectedCourseIds, setSelectedCourseIds] =
    useState<string[]>(initialCourses);
  ...
  useEffect(() => {
    ...
    if (!hasSeenMobileAlert && window.innerWidth < 768) {
      toast.info("📱 Mobile Device Detected", {
        description:
          "For the best experience, please turn on 'Desktop Site' in your browser settings!",
        duration: 8000,
        position: "top-center",
      });
  ...
  const { courses, addCourse, removeCourse, teachers, addTeacher } =
    useScheduleStore();
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-blue-700/80 dark:text-blue-300/80 mt-1 leading-relaxed">
                Before Planning your timetable, you must select the courses you
                wish to take this semester. Search the list below and add them
                to your selection cart. Once you have picked everything you
                need, click Proceed to start planning your {semesterName}!!
              </p>
            </div>
          </MotionDiv>
                      ...
                      <div
                        className={`w-8 h-8 rounded-full flex items-center justify-center transition-colors ${
                          isSelected
                            ...
                            : "bg-muted text-muted-foreground group-hover:bg-purple-500/20 group-hover:text-purple-600"
                        }`}
                      >
                        {isSelected ? (
              ...
              {selectedCourseIds.length === 0 ? (
                <div className="h-full flex flex-col items-center justify-center text-center opacity-60">
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    Click on a course to add it to your list.
                  </p>
                </div>
              ) : (
                selectedCourseIds.map((id) => {
                  ...
                  return (
                    <div
                      key={id}
                      className="flex items-center justify-between p-3 bg-muted/40 rounded-xl border border-border group"
                    >
                      <div className="pr-2">
        ...
        >
          <div className="flex items-center justify-between gap-4 max-w-md mx-auto">
            <Sheet>
              ...
              <SheetContent
                side="bottom"
                className="h-[80vh] rounded-t-2xl flex flex-col pt-6"
              >
