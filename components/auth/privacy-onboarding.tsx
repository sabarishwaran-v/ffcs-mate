    ...
    >
      ...
      >
        <DialogHeader>
          ...
          <DialogDescription>
            Before you join or create a room, let's configure your privacy
            settings. Your privacy is our top priority.
          </DialogDescription>
        </DialogHeader>
            ...
            <div className="flex flex-col gap-2">
              <label
                className={`flex items-center space-x-3 border p-3 rounded-md cursor-pointer transition-colors ${
                  settings.displayIdentity === "full_name"
              ...
              >
                <input
                  ...
                  onChange={() =>
                    setSettings({ ...settings, displayIdentity: "full_name" })
                  }
              ...
              <label
                className={`flex items-center space-x-3 border p-3 rounded-md cursor-pointer transition-colors ${
                  settings.displayIdentity === "reg_no"
                    ? "border-purple-500 bg-purple-500/5"
                    : "hover:bg-muted/50"
                }`}
              >
                <input
                  ...
                  onChange={() =>
                    setSettings({ ...settings, displayIdentity: "reg_no" })
                  }
                  className="w-4 h-4 text-purple-600 focus:ring-purple-500"
                />
                <div className="flex flex-col">
                  <span className="font-medium text-sm">
                    Show Registration Number Only
                  </span>
                  <span className="text-xs text-muted-foreground">
                    e.g. "{userData?.registrationNumber || "21BCEXXXX"}"
                  </span>
                </div>
              </label>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div className="flex flex-col gap-1 pr-4">
                ...
                <span className="text-xs text-muted-foreground">
                  Allow friends to send you room requests using your
                  Registration Number.
                </span>
              </div>
              <Switch
                ...
                onCheckedChange={(c) =>
                  setSettings({ ...settings, discoverable: c })
                }
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex flex-col gap-1 pr-4">
                ...
                <span className="text-xs text-muted-foreground">
                  Display a green dot when you are actively viewing a room.
                </span>
              </div>
              <Switch
                id="presence"
                ...
                onCheckedChange={(c) =>
                  setSettings({ ...settings, showPresence: c })
                }
              />
            </div>
          </div>
        ...
        <DialogFooter>
          <Button
            onClick={handleSave}
            disabled={isSaving}
            className="w-full bg-gradient-to-r from-purple-500 to-blue-600 text-white hover:opacity-90 transition-all duration-300"
          >
