  ...
  return (
    <div className="bg-[#1e293b] p-4 sm:p-6 pb-4 shadow-sm z-10 border-b border-slate-700/50 flex-shrink-0">
      <div className="flex flex-col sm:flex-row gap-4 sm:items-center justify-between">
        ...
        <div className="flex flex-col gap-1.5 shrink-0 bg-slate-800/50 p-3 rounded-xl border border-slate-700/50 shadow-inner w-full sm:w-auto">
          <div className="flex justify-between sm:w-48 text-[10px] sm:text-xs font-bold text-slate-400 uppercase tracking-wider px-2">
          ...
          <div className="flex justify-between sm:w-48 text-sm sm:text-base font-bold text-blue-400 px-2">
