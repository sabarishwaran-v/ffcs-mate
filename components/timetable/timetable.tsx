...
const schema = {
  theory: [
    ...
    },
    {
      ...
      days: { tue: "A1", wed: "D1", thu: "C1", fri: "B1", sat: "TC1" },
    },
    { start: "09:01", end: "09:51", days: { tue: "SE2", fri: "SA2" } },
    {
      start: "10:00",
      end: "10:50",
      days: { tue: "B1", wed: "F1", thu: "D1", fri: "A1", sat: "C1" },
    },
    { start: "10:01", end: "10:51", days: { tue: "SD2", fri: "SF2" } },
    {
      start: "11:00",
      end: "11:50",
      days: { tue: "C1", wed: "G1", thu: "A1", fri: "G1", sat: "F1" },
    },
    {
      start: "11:01",
      end: "11:51",
    ...
    },
    {
      ...
      days: { tue: "D1", wed: "B1", thu: "F1", fri: "E1", sat: "G1" },
    },
    ...
    { lunch: true },
    {
      ...
      days: { tue: "F2", wed: "D2", thu: "E2", fri: "TC2", sat: "G2" },
    },
    { start: "14:01", end: "14:51", days: { sat: "TD2" } },
    {
      start: "15:00",
      end: "15:50",
      days: { tue: "A2", wed: "F2", thu: "C2", fri: "B2", sat: "D2" },
    },
    { start: "15:01", end: "15:51", days: { tue: "SF1", fri: "SA1" } },
    {
      start: "16:00",
      end: "16:50",
      days: { tue: "B2", wed: "B2", thu: "A2", fri: "A2", sat: "F2" },
    },
    {
      start: "16:01",
      end: "16:51",
    ...
    },
    {
      ...
      days: { tue: "C2", wed: "G2", thu: "D2", fri: "G2", sat: "C2" },
    },
  ...
  lab: [
    {
      ...
      days: { tue: "L1", wed: "L7", thu: "L13", fri: "L19", sat: "L25" },
    },
    {
      start: "08:50",
      end: "09:40",
      days: { tue: "L2", wed: "L8", thu: "L14", fri: "L20", sat: "L26" },
    },
    { start: "08:51", end: "09:41", days: {} },
    {
      start: "09:50",
      end: "10:40",
      days: { tue: "L3", wed: "L9", thu: "L15", fri: "L21", sat: "L27" },
    },
    { start: "09:51", end: "10:41", days: {} },
    {
      start: "10:40",
      end: "11:30",
      days: { tue: "L4", wed: "L10", thu: "L16", fri: "L22", sat: "L28" },
    },
    { start: "10:41", end: "11:31", days: {} },
    {
      start: "11:45",
      end: "12:30",
      days: { tue: "L5", wed: "L11", thu: "L17", fri: "L23", sat: "L29" },
    },
    { start: "11:46", end: "12:31", days: {} },
    {
      start: "12:30",
      end: "13:10",
      days: { tue: "L6", wed: "L12", thu: "L18", fri: "L24", sat: "L30" },
    },
    { lunch: true },
    {
      start: "14:00",
      end: "14:50",
      days: { tue: "L31", wed: "L37", thu: "L43", fri: "L49", sat: "L55" },
    },
    { start: "14:01", end: "14:51", days: {} },
    {
      start: "14:50",
      end: "15:40",
      days: { tue: "L32", wed: "L38", thu: "L44", fri: "L50", sat: "L56" },
    },
    { start: "14:51", end: "15:41", days: {} },
    {
      start: "16:00",
      end: "16:50",
      days: { tue: "L33", wed: "L39", thu: "L45", fri: "L51", sat: "L57" },
    },
    { start: "16:01", end: "16:51", days: {} },
    {
      start: "16:50",
      end: "17:40",
      days: { tue: "L34", wed: "L40", thu: "L46", fri: "L52", sat: "L58" },
    },
    { start: "16:51", end: "17:41", days: {} },
    {
      start: "18:00",
      end: "18:50",
      days: { tue: "L35", wed: "L41", thu: "L47", fri: "L53", sat: "L59" },
    },
    {
      start: "18:50",
      end: "19:30",
      days: { tue: "L36", wed: "L42", thu: "L48", fri: "L54", sat: "L60" },
    },
  ],
};
...
const groupOverlappingTimes = (theoryTimes: string[], labTimes: string[]) => {
  ...
  return groups.sort(
    (a, b) =>
      Math.min(...a.times.map((t: any) => t.startMin)) -
      Math.min(...b.times.map((t: any) => t.startMin))
  );
};
...
export const Timetable = React.memo(function Timetable({
  hideControls = false,
}: TimetableProps = {}) {
  ...
  const { allTimeGroups, timetableData } = useMemo(() => {
    ...
    for (const teacher of selectedTeachers) {
      ...
      for (const slot of allSlots) {
        ...
        tData[slot].authors.push({
          uid: teacher.addedByUid,
          name: teacher.addedByName,
        });
      }
    }
  ...
  const renderCell = (
    ...
    if (!slotName || slotName === "-") {
      return (
        <td
          style={{
            border: `1px solid ${VTOP_COLORS.borderColor}`,
            backgroundColor: isLabRow
              ? VTOP_COLORS.labSlotBg
              : VTOP_COLORS.theorySlotBg,
    ...
    const cellContent = isClash ? (
      ...
      <div className="flex flex-col items-center leading-tight gap-0.5 py-1 relative w-full h-full justify-center">
        <span style={{ fontSize: "11px" }}>{primarySlot}</span>
        <span style={{ fontSize: "11px" }}>{uniqueCourses[0].code}</span>
        {activeRoomId && author?.name && (
          <div
            className={`absolute top-0 right-0 w-2 h-2 rounded-full shadow-sm ${getAvatarColor(
              author.uid || ""
            )}`}
          />
        )}
              ...
              {isClash ? (
                <div className="space-y-1">
                  ...
                  {uniqueCourses.map((c, i) => {
                    const cAuthor = timetableData[
                      slotsInCell.find((s) =>
                        timetableData[s].courses.some((cc) => cc.id === c.id)
                      )!
                    ]?.authors.find(
                      (_, idx) =>
                        timetableData[
                          slotsInCell.find((s) =>
                            timetableData[s].courses.some(
                              (cc) => cc.id === c.id
                            )
                          )!
                        ].courses[idx].id === c.id
                ...
                <div className="space-y-1">
                  <p className="font-bold">
                    {uniqueCourses[0]?.title || uniqueCourses[0]?.code}
                  </p>
                  {activeRoomId && author?.name && (
              ...
              <tr>
                ...
                {allTimeGroups.map((group, idx) => (
                  <td
                    ...
                    style={{
                      ...baseThStyle,
                      backgroundColor: group.isLunch
                        ? VTOP_COLORS.labelBg
                        : VTOP_COLORS.theoryTimeBg,
                    }}
                  >
                    {group.isLunch
                      ? "Lunch"
                      : group.theoryTimes[0]
                      ? group.theoryTimes[0].split("-")[0]
                      : "-"}
                  </td>
                ))}
              </tr>
                ...
                {allTimeGroups.map((group, idx) => (
                  <td
                    ...
                    style={{
                      ...
                      backgroundColor: group.isLunch
                        ? VTOP_COLORS.labelBg
                        : VTOP_COLORS.labTimeBg,
                    }}
                  >
                    {group.isLunch
                      ? "Lunch"
                      : group.labTimes[0]
                      ? group.labTimes[0].split("-")[0]
                      : "-"}
                  </td>
                ))}
              </tr>
                  ...
                  <React.Fragment key={day}>
                    ...
                    <tr>
                      ...
                      <td
                        style={{
                          ...baseThStyle,
                          backgroundColor: VTOP_COLORS.theoryTimeBg,
                        }}
                      >
                        THEORY
                      </td>
                      {allTimeGroups.map((group, idx) => {
                        if (group.isLunch) {
                          ...
                          return (
                            <React.Fragment key={`lunch-${day}-${idx}`}>
                              {renderCell("", true, false)}
                            </React.Fragment>
                          );
                        }
                        ...
                        return (
                          <React.Fragment key={`t-${day}-${idx}`}>
                            {renderCell(slotName, false, false)}
                          </React.Fragment>
                        );
                      })}
                    </tr>
                    ...
                    <tr>
                      <td
                        style={{
                          ...baseThStyle,
                          backgroundColor: VTOP_COLORS.labTimeBg,
                        }}
                      >
                        LAB
                      </td>
                      {allTimeGroups.map((group, idx) => {
                        ...
                        return (
                          <React.Fragment key={`l-${day}-${idx}`}>
                            {renderCell(slotName, false, true)}
                          </React.Fragment>
                        );
                      })}
                    </tr>
