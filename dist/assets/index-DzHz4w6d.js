...
` +
    ...
    var Kn = En(
      ...
      Jn = En(h({}, Dn, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 })),
      Yn = En(
        h({}, Pn, {
          deltaX: function (e) {
            return `deltaX` in e
    ...
    function vi(e, t, n, r, a, o) {
      ...
      if (((r = e), typeof e == `function`)) hi(e) && (s = 1);
        ...
        a: switch (e) {
          case re:
            return (
              (e = mi(31, n, t, a)), (e.elementType = re), (e.lanes = o), e
            );
          case y:
          ...
          case te:
            return (
              (e = mi(13, n, t, a)), (e.elementType = te), (e.lanes = o), e
            );
          case w:
            return (e = mi(19, n, t, a)), (e.elementType = w), (e.lanes = o), e;
          default:
    ...
    function zo(e, t, n) {
      ...
      if (((o = e.baseState), a === null)) e.memoizedState = o;
        ...
        if (
          (l === null ? (s = o) : (l.next = c),
          !Or(o, e.memoizedState) && ((H = !0), d && ((n = _a), n !== null)))
        )
          throw n;
        (e.memoizedState = o),
          (e.baseState = s),
    ...
    function _u(e, t, n, r, i, a, o, s, c, l, u, d, f, p) {
      if (
        ...
        (d = {
          ...
          Ml(t, a, d);
        var m =
          (a & 62914560) === a ? $l - k() : (a & 4194048) === a ? eu - k() : 0;
        if (((m = qf(d, m)), m !== null)) {
          (su = a),
...
function E(e, t, n, r, i) {
  let a = Ee((typeof t == `string` ? oe(t) : t).pathname || `/`, n);
...
function be(e, t) {
  ...
  return (
    ...
    n
      .filter((e) => !ye(e))
      .reduce((e, t) => e + (me.test(t) ? O : t === `` ? ge : _e), r)
  );
}
function xe(e, t) {
  ...
  for (let e = 0; e < r.length; ++e) {
    ...
    Object.assign(i, u.params),
      o.push({
        ...
        pathnameBase: Ie(k([a, u.pathnameBase])),
        route: d,
      }),
...
var Je = _.createContext(!1);
function Ye() {
  return _.useContext(Je);
}
var Xe = _.createContext({ isTransitioning: !1 });
Xe.displayName = `ViewTransition`;
var Ze = _.createContext(new Map());
...
function st(e, { relative: t } = {}) {
  ...
  let { basename: n, navigator: r } = _.useContext(A),
...
function dt(e) {
  _.useContext(A).static || _.useLayoutEffect(e);
}
function ft() {
...
function pt() {
  ...
  let e = _.useContext(Ke),
    { basename: t, navigator: n } = _.useContext(A),
  ...
  return (
    ...
    _.useCallback(
      (r, s = {}) => {
        if ((T(o.current, ut), !o.current)) return;
        if (typeof r == `number`) {
          n.go(r);
          return;
        }
...
function ht(e, t, n) {
  ...
  let { navigator: r } = _.useContext(A),
...
var _t = _.createElement(gt, null),
  vt = class extends _.Component {
    constructor(e) {
      super(e),
        (this.state = {
          location: e.location,
    ...
    render() {
      ...
      return this.context ? _.createElement(bt, { error: e }, t) : t;
    }
  };
vt.contextType = Je;
var yt = new WeakMap();
function bt({ children: e, error: t }) {
  let { basename: n } = _.useContext(A);
  if (
    typeof t == `object` &&
    t &&
    `digest` in t &&
...
function At() {
  ...
  return _.useMemo(() => e.map((e) => D(e, t)), [e, t]);
}
function jt() {
...
function zt(e, t = []) {
  ...
  return (
    _.Children.forEach(e, (e, r) => {
      ...
      e.props.children && (a.children = zt(e.props.children, i)), n.push(a);
    }),
    n
  );
}
...
function Qt(e, t) {
  ...
  if (Wt(e)) {
    ...
    (r = o ? Ee(o, t) : null),
      (n = e.getAttribute(`method`) || Bt),
      (i = Zt(e.getAttribute(`enctype`)) || Vt),
      (a = new FormData(e));
  } else if (Ut(e) || (Gt(e) && (e.type === `submit` || e.type === `image`))) {
    let o = e.form;
    if (o == null)
      throw Error(
    ...
    if (
      ((r = s ? Ee(s, t) : null),
      (n = e.getAttribute(`formmethod`) || o.getAttribute(`method`) || Bt),
      (i =
        Zt(e.getAttribute(`formenctype`)) ||
        Zt(o.getAttribute(`enctype`)) ||
        Vt),
      (a = new FormData(o, e)),
      !Yt())
    ) {
...
var gn = _.createContext(void 0);
gn.displayName = `FrameworkContext`;
function _n() {
  let e = _.useContext(gn);
  return (
    nn(e, `You must render this element inside a <HydratedRouter> element`), e
  );
}
function vn(e, t) {
...
function bn({ page: e, ...t }) {
  let n = Ye(),
    { router: r } = mn(),
    i = _.useMemo(() => le(r.routes, e, r.basename), [r.routes, e, r.basename]);
  return i
    ? n
      ? _.createElement(Sn, { page: e, matches: i, ...t })
...
function Sn({ page: e, matches: t, ...n }) {
  let r = lt(),
    ...
    o = _.useMemo(() => {
      ...
      let n = rn(e, a, i.v8_trailingSlashAwareDataRequests, `rsc`),
        o = !1,
        s = [];
      for (let e of t)
...
function Cn({ page: e, matches: t, ...n }) {
  let r = lt(),
    { future: i, manifest: a, routeModules: o } = _n(),
    { basename: s } = mn(),
    { loaderData: c, matches: l } = hn(),
    u = _.useMemo(() => ln(e, t, l, a, r, `data`), [e, t, l, a, r]),
    d = _.useMemo(() => ln(e, t, l, a, r, `assets`), [e, t, l, a, r]),
    f = _.useMemo(() => {
      if (e === r.pathname + r.search + r.hash) return [];
      let n = new Set(),
        l = !1;
...
var Tn =
  ...
  window.document.createElement !== void 0;
try {
  Tn && (window.__reactRouterVersion = `7.17.0`);
} catch {}
...
function Dn({ basename: e, children: t, history: n, useTransitions: r }) {
...
var On = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,
  kn = _.forwardRef(function (
    ...
    let { basename: h, navigator: g, useTransitions: v } = _.useContext(A),
      y = typeof l == `string` && On.test(l),
      b = Ue(l, h);
    l = b.to;
    let x = st(l, { relative: r }),
      ...
      S = null;
    if (o) {
      let e = Ne(o, [], ee.mask ? ee.mask.pathname : `/`, !0);
      h !== `/` && (e.pathname = e.pathname === `/` ? h : k([h, e.pathname])),
        (S = g.createHref(e));
    }
    let [C, te, w] = vn(n, p),
      T = In(l, {
    ...
    let re = !(b.isExternal || i),
      ie = _.createElement(`a`, {
        ...p,
        ...w,
        href: (re ? S : void 0) || b.absoluteURL || x,
        onClick: re ? ne : e,
        ref: wn(m, te),
        target: c,
    ...
    return C && !y
      ? _.createElement(_.Fragment, null, ie, _.createElement(bn, { page: x }))
      : ie;
  });
kn.displayName = `Link`;
var An = _.forwardRef(function (
  {
    "aria-current": e = `page`,
    caseSensitive: t = !1,
    className: n = ``,
  ...
  let u = j(a, { relative: c.relative }),
    d = lt(),
    f = _.useContext(qe),
    { navigator: p, basename: m } = _.useContext(A),
    h = f != null && Kn(u) && o === !0,
...
var jn = _.forwardRef(
  (
    ...
    let { useTransitions: h } = _.useContext(A),
      g = zn(),
      v = Bn(s, { relative: l }),
      y = o.toLowerCase() === `get` ? `get` : `post`,
      b = typeof s == `string` && On.test(s);
...
function Mn({ getKey: e, storageKey: t, ...n }) {
  let r = _.useContext(gn),
    { basename: i } = _.useContext(A),
    a = lt(),
    o = At();
  Wn({ getKey: e, storageKey: t });
  let s = _.useMemo(() => {
    if (!r || !e) return null;
    let t = Un(a, o, i, e);
  ...
  return _.createElement(`script`, {
    ...
    dangerouslySetInnerHTML: {
      __html: `(${c})(${tn(JSON.stringify(t || Vn))}, ${tn(
        JSON.stringify(s)
      )})`,
    },
  });
...
function zn() {
  let { router: e } = Pn(`useSubmit`),
    { basename: t } = _.useContext(A),
    n = Ot(),
    r = e.fetch,
    i = e.navigate;
  return _.useCallback(
    async (e, a = {}) => {
      let { action: o, method: s, encType: c, formData: l, body: u } = Qt(e, t);
      a.navigate === !1
        ? await r(a.fetcherKey || Rn(), n, a.action || o, {
...
function Bn(e, { relative: t } = {}) {
  ...
  return (
    ...
    n !== `/` && (a.pathname = a.pathname === `/` ? n : k([n, a.pathname])),
    ae(a)
  );
}
...
function Jn() {
  return (0, M.jsx)(`header`, {
    className: `bg-[#004d40] text-white p-4 shadow-md sticky top-0 z-50`,
    children: (0, M.jsxs)(`div`, {
      ...
      children: [
        ...
        (0, M.jsx)(`div`, {
          className: `text-sm`,
          children: `SUMMER SEMESTER 2025-26`,
        }),
      ],
    }),
  });
...
function Yn() {
  return (0, M.jsx)(`footer`, {
    className: `bg-[#004d40] text-white py-3 fixed bottom-0 w-full text-center text-xs`,
    children: (0, M.jsx)(`div`, {
      className: `max-w-7xl mx-auto`,
      children: `© 2026 FFCS Mate. All Rights Reserved.`,
    }),
  });
}
var Xn = (...e) =>
    e
      ...
      .join(` `)
      .trim(),
  Zn = (e) => e.replace(/([a-z0-9])([A-Z])/g, `$1-$2`).toLowerCase(),
  Qn = (e) =>
  ...
  nr = (0, _.createContext)({}),
  rr = () => (0, _.useContext)(nr),
  ir = (0, _.forwardRef)(
    (
      {
        color: e,
      ...
      return (0, _.createElement)(
        `svg`,
        {
          ...
          ...er,
          width: t ?? l ?? er.width,
          height: t ?? l ?? er.height,
          stroke: e ?? f,
          strokeWidth: m,
          className: Xn(`lucide`, p, i),
          ...(!a && !tr(s) && { "aria-hidden": `true` }),
          ...s,
        },
        [
  ...
  ar = (e, t) => {
    let n = (0, _.forwardRef)(({ className: n, ...r }, i) =>
      (0, _.createElement)(ir, {
        ref: i,
        iconNode: t,
        className: Xn(`lucide-${Zn($n(e))}`, `lucide-${e}`, n),
        ...r,
      })
    );
...
function xr() {
  let e = ft();
  return (0, M.jsxs)(`div`, {
    className: `flex flex-col items-center justify-center min-h-[calc(100vh-140px)] p-6`,
    children: [
      (0, M.jsxs)(`div`, {
        className: `text-center max-w-3xl mb-12 animate-fade-in-up`,
        children: [
          (0, M.jsxs)(`h1`, {
            className: `text-5xl font-extrabold text-gray-900 mb-6 tracking-tight`,
            children: [
              `Master Your Semester with `,
              (0, M.jsx)(`span`, {
          ...
          (0, M.jsx)(`p`, {
            ...
            children: `The ultimate scheduling and collaboration tool designed exclusively for VIT-AP students. Say goodbye to complex spreadsheets and build your perfect timetable in minutes.`,
          }),
        ],
      }),
      (0, M.jsx)(`div`, {
        ...
        children: (0, M.jsxs)(`div`, {
          ...
          children: [
            (0, M.jsx)(`div`, {
              className: `bg-blue-50 w-16 h-16 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform`,
              children: (0, M.jsx)(cr, { className: `w-8 h-8 text-[#0056b3]` }),
            }),
            (0, M.jsx)(`h2`, {
              className: `text-2xl font-bold text-gray-900 mb-3`,
              children: `FFCS Planner`,
            }),
            (0, M.jsx)(`p`, {
              className: `text-gray-600 mb-6`,
              children: `Build your personal timetable, instantly check for clashes, and collaborate with your friends in real-time.`,
            }),
            (0, M.jsxs)(`div`, {
              className: `flex items-center font-semibold text-[#0056b3] group-hover:gap-2 transition-all`,
              children: [
                `Open Planner `,
                (0, M.jsx)(or, { className: `w-5 h-5 ml-1` }),
              ],
            }),
          ],
        }),
...
function Sr() {
  ...
  return (0, M.jsx)(`div`, {
    className: `flex flex-col items-center justify-center min-h-[calc(100vh-140px)] p-6`,
    children: (0, M.jsxs)(`div`, {
      className: `bg-white rounded-2xl shadow-lg border border-gray-100 p-10 max-w-2xl w-full`,
      children: [
        (0, M.jsx)(`h2`, {
        ...
        (0, M.jsx)(`p`, {
          ...
          children: `Choose the semester you are planning for to load the correct course catalog and timetable slots.`,
        }),
        (0, M.jsx)(`div`, {
          className: `space-y-4`,
          children: [
            {
              ...
              icon: (0, M.jsx)(sr, { className: `w-6 h-6 text-blue-600` }),
            },
            {
              id: `fall_24`,
              name: `Fall Semester`,
              batch: `2024-25`,
              icon: (0, M.jsx)(fr, { className: `w-6 h-6 text-emerald-600` }),
            },
            {
              id: `summer_25`,
              name: `Summer Semester`,
              batch: `2025-26`,
              icon: (0, M.jsx)(_r, { className: `w-6 h-6 text-orange-500` }),
            },
          ].map((t) =>
            (0, M.jsxs)(
              `button`,
              {
                ...
                children: [
                  (0, M.jsx)(`div`, {
                    className: `bg-gray-50 group-hover:bg-white p-3 rounded-lg mr-4 transition-colors shadow-sm`,
                    children: t.icon,
                  }),
                  (0, M.jsxs)(`div`, {
                    children: [
                      (0, M.jsx)(`h3`, {
                        className: `text-lg font-semibold text-gray-900 group-hover:text-[#0056b3] transition-colors`,
                        children: t.name,
                      }),
                      (0, M.jsx)(`p`, {
...
var Ar = (e) => (t) => {
  ...
  jr = Or()(
    ((e, t) => (n, r, i) => {
      let a = {
          storage: kr(() => window.localStorage),
          partialize: (e) => e,
          version: 0,
          merge: (e, t) => ({ ...t, ...e }),
          ...t,
      ...
      let m,
        h = () => {
          ...
          return Ar(u.getItem.bind(u))(a.name)
            .then((e) => {
              if (e)
      ...
      (e, t) => ({
        ...
        name: null,
        email: null,
        privacy: { shareRegNo: !1, discoverable: !1 },
        hoveredSlots: [],
        baseCourses: [],
        courseOptions: {},
        selectedCourses: [],
        isVitApMode: !1,
        login: (t, n, r) => e({ regNo: t, name: n, email: r }),
        updatePrivacy: (t) => e((e) => ({ privacy: { ...e.privacy, ...t } })),
        setHoveredSlots: (t) => e({ hoveredSlots: t }),
        setVitApMode: (t) => e({ isVitApMode: t }),
        addBaseCourse: (t) =>
          e((e) => ({ baseCourses: [...e.baseCourses, t] })),
        removeBaseCourse: (t) =>
          e((e) => ({
            baseCourses: e.baseCourses.filter((e) => e.code !== t),
            selectedCourses: e.selectedCourses.filter((e) => e.code !== t),
          })),
        setCourseOptions: (t, n) =>
          e((e) => ({ courseOptions: { ...e.courseOptions, [t]: n } })),
        checkClash: (e) => {
          let { selectedCourses: n } = t();
          return n.filter((t) => t.slots.some((t) => e.includes(t)));
        },
        addCourse: (n) => {
          let r = t().checkClash(n.slots);
          return r.length > 0
            ? { success: !1, clashingWith: r }
            : (e((e) => ({ selectedCourses: [...e.selectedCourses, n] })),
              { success: !0 });
        },
        removeCourse: (t) =>
          e((e) => ({
            selectedCourses: e.selectedCourses.filter((e) => e.id !== t),
          })),
        logout: () =>
          e({
            regNo: null,
...
function Mr() {
  let e = ft(),
    { user: t, login: n, updatePrivacy: r } = jr(),
    [i, a] = (0, _.useState)(``),
    [o, s] = (0, _.useState)(`LOGIN`);
  return o === `PRIVACY` && t
    ? (0, M.jsx)(`div`, {
        className: `flex flex-col items-center justify-center min-h-[calc(100vh-140px)] p-6`,
        children: (0, M.jsxs)(`div`, {
          className: `bg-white rounded-2xl shadow-lg border border-gray-100 p-10 max-w-lg w-full animate-fade-in-up`,
          children: [
            (0, M.jsx)(`div`, {
              className: `flex justify-center mb-6`,
              children: (0, M.jsx)(`div`, {
                className: `bg-emerald-100 p-4 rounded-full text-emerald-600`,
                children: (0, M.jsx)(lr, { className: `w-12 h-12` }),
              }),
            }),
            (0, M.jsxs)(`h2`, {
            ...
            (0, M.jsxs)(`div`, {
              ...
              children: [
                (0, M.jsxs)(`h3`, {
                  className: `flex items-center text-blue-900 font-semibold mb-2`,
                  children: [
                    (0, M.jsx)(gr, { className: `w-5 h-5 mr-2` }),
                    ` Privacy Settings`,
                  ],
                }),
                (0, M.jsx)(`p`, {
                  className: `text-sm text-blue-800 mb-4`,
                  children: `Since you will be able to collaborate with friends, we want to respect your privacy.`,
                }),
                (0, M.jsxs)(`div`, {
                  className: `space-y-4`,
                  children: [
                    (0, M.jsxs)(`label`, {
                      ...
                      children: [
                        (0, M.jsx)(`input`, {
                          type: `checkbox`,
                          checked: t.privacy.shareRegNo,
                          onChange: (e) => r({ shareRegNo: e.target.checked }),
                        ...
                        (0, M.jsxs)(`div`, {
                          children: [
                            (0, M.jsx)(`div`, {
                              ...
                              children: `Share my Registration Number`,
                            }),
                            (0, M.jsx)(`div`, {
                              className: `text-sm text-gray-500`,
                              children: `Allow collaborative partners to see your Reg No. Otherwise, they only see your first name.`,
                            }),
                          ],
                        }),
                      ],
                    ...
                    (0, M.jsxs)(`label`, {
                      ...
                      children: [
                        (0, M.jsx)(`input`, {
                          type: `checkbox`,
                          checked: t.privacy.discoverable,
                          onChange: (e) =>
                            r({ discoverable: e.target.checked }),
                          className: `mt-1 w-5 h-5 text-[#0056b3] rounded border-gray-300 focus:ring-[#0056b3]`,
                        }),
                        (0, M.jsxs)(`div`, {
                          children: [
                            (0, M.jsx)(`div`, {
                              className: `font-medium text-gray-900`,
                              children: `Make me Discoverable`,
                            }),
                            (0, M.jsx)(`div`, {
                              className: `text-sm text-gray-500`,
                              children: `Allow other students to find you and invite you to collaborate.`,
                            }),
                          ],
                        }),
                      ],
    ...
    : (0, M.jsx)(`div`, {
        className: `flex flex-col items-center justify-center min-h-[calc(100vh-140px)] p-6`,
        children: (0, M.jsxs)(`div`, {
          className: `bg-white rounded-2xl shadow-lg border border-gray-100 p-10 max-w-md w-full animate-fade-in-up`,
          children: [
            (0, M.jsx)(`div`, {
              className: `flex justify-center mb-6`,
              children: (0, M.jsx)(`div`, {
                className: `bg-blue-50 p-4 rounded-full text-[#0056b3]`,
                children: (0, M.jsx)(ur, { className: `w-12 h-12` }),
              }),
            }),
            (0, M.jsx)(`h2`, {
              className: `text-2xl font-bold text-center text-gray-900 mb-2`,
            ...
            (0, M.jsx)(`p`, {
              className: `text-center text-gray-500 mb-8`,
              children: `To use the Collaborative Planner and save your progress to the cloud, you must sign in.`,
            }),
            i &&
              (0, M.jsx)(`div`, {
                className: `bg-red-50 text-red-700 p-4 rounded-lg text-sm mb-6 border border-red-200`,
                children: i,
              }),
            (0, M.jsxs)(`button`, {
              onClick: () => {
                try {
                  n(`sabarishwaran.25bce7xxx@vitapstudent.ac.in`), s(`PRIVACY`);
                } catch (e) {
                  a(e.message);
                }
              },
              ...
              children: [
                ...
                (0, M.jsx)(`span`, { children: `Sign In with Google` }),
              ],
            }),
            (0, M.jsxs)(`p`, {
...
`
  ...
  return (
    t.forEach((e) => {
      ...
      if (
        (t.length < 4 && (t = e.split(/\s{2,}/).map((e) => e.trim())),
        t.length >= 4)
      ) {
        let e = t[0],
          r = t[1],
...
`
  ...
  return (
    n.forEach((e) => {
      ...
      if (
        (n.length < 3 && (n = e.split(/\s{2,}/).map((e) => e.trim())),
        n.length >= 3)
      ) {
        let e = n[0],
          i = n[1],
          a = n[2],
          o = e.includes(`L`) && /[0-9]/.test(e),
          s = e
            .split(`+`)
            .map((e) => e.trim())
            .filter(Boolean);
        s.length > 0 &&
          !e.toLowerCase().includes(`slot`) &&
          r.push({
            id: Math.random().toString(36).substr(2, 9),
            code: t,
            title: `Course`,
            type: o ? `Embedded Lab` : `Embedded Theory`,
            slots: s,
            fullSlotString: e,
            faculty: a,
            venue: i,
...
function Fr({
  ...
  let [a, o] = (0, _.useState)(n),
    s = t.filter((e) => !e.isLab),
    c = t.filter((e) => e.isLab),
    l = t[0] || {};
  return (0, M.jsx)(`div`, {
    className: `fixed inset-0 z-50 bg-black/60 flex items-center justify-center p-4`,
    children: (0, M.jsxs)(`div`, {
      className: `bg-white bg-dot-pattern rounded-xl shadow-2xl w-full max-w-5xl max-h-[90vh] overflow-y-auto font-sans relative`,
      children: [
        (0, M.jsx)(`div`, {
          className: `w-full bg-white border-b border-gray-200 sticky top-0 z-10 shadow-sm`,
          children: (0, M.jsxs)(`div`, {
            className: `px-6 py-4 flex justify-between items-center`,
            children: [
              (0, M.jsx)(`h2`, {
                className: `text-xl font-bold text-slate-800`,
                children: `Select Faculty & Slot`,
              }),
              (0, M.jsx)(`button`, {
                onClick: i,
          ...
          children: [
            (0, M.jsx)(`div`, {
              ...
              children: (0, M.jsxs)(`table`, {
                className: `w-full text-xs font-bold text-gray-700 text-center`,
                children: [
                  (0, M.jsx)(`thead`, {
                    children: (0, M.jsxs)(`tr`, {
                      ...
                      children: [
                        ...
                        (0, M.jsx)(`th`, {
                          className: `py-4 px-4`,
                          children: `COURSE TYPE (ELIGIBLE COMPONENTS)`,
                        }),
                        (0, M.jsx)(`th`, {
                          className: `py-4 px-4`,
                  ...
                  (0, M.jsx)(`tbody`, {
                    children: (0, M.jsxs)(`tr`, {
                      children: [
                        ...
                        (0, M.jsx)(`td`, {
                          className: `py-4 px-4 text-blue-800`,
                          children: l.ltpjc || `3 0 0 0 3.0`,
                        }),
                        (0, M.jsx)(`td`, {
                          className: `py-4 px-4`,
                          children: l.type || `Theory Only`,
                        }),
                        (0, M.jsx)(`td`, {
                          className: `py-4 px-4`,
                          children: l.category || `UC`,
                        }),
                      ],
                    }),
                  }),
            ...
            (0, M.jsx)(`div`, {
              ...
              children: (0, M.jsxs)(`table`, {
                ...
                children: [
                  (0, M.jsx)(`thead`, {
                    children: (0, M.jsxs)(`tr`, {
                      className: `border-b border-gray-200 text-gray-600 bg-gray-50`,
                      children: [
                        (0, M.jsx)(`th`, {
                  ...
                  (0, M.jsxs)(`tbody`, {
                    ...
                    children: [
                      s.length > 0 &&
                        (0, M.jsx)(`tr`, {
                          className: `bg-[#1a233a] text-white text-left`,
                          children: (0, M.jsx)(`td`, {
                            colSpan: 4,
                            className: `py-2 px-4 uppercase tracking-wider text-[10px]`,
                            children: `EMBEDDED THEORY SLOTS`,
                          }),
                        }),
                      s.map((t) =>
                        (0, M.jsxs)(
                          `tr`,
                          {
                            className: `border-b border-gray-100 ${
                              a === t.id ? `bg-blue-50` : `hover:bg-gray-50`
                            }`,
                            children: [
                              (0, M.jsx)(`td`, {
                                className: `py-4 px-4 text-black`,
                                children: t.fullSlotString || t.slots.join(`+`),
                              }),
                              (0, M.jsx)(`td`, {
                                className: `py-4 px-4 text-gray-600 font-normal`,
                                children: t.venue,
                              }),
                              (0, M.jsx)(`td`, {
                                className: `py-4 px-4 text-gray-600 font-normal uppercase`,
                                children: t.faculty,
                              }),
                              (0, M.jsx)(`td`, {
                                className: `py-4 px-4`,
                      ...
                      (0, M.jsxs)(`tr`, {
                        ...
                        children: [
                          (0, M.jsx)(`td`, {
                            className: `py-6 px-4 font-bold text-left text-sm text-gray-800`,
                          ...
                          (0, M.jsx)(`td`, {
                            ...
                            children: (0, M.jsxs)(`label`, {
                              className: `flex items-center space-x-2 border border-gray-200 bg-white p-3 rounded max-w-[200px]`,
                              children: [
                                (0, M.jsx)(`input`, {
                                  type: `radio`,
                                  checked: !0,
                ...
                (0, M.jsx)(`button`, {
                  onClick: () => {
                    if (a) {
                      ...
                      e && r(e);
                    } else alert(`Please select a faculty and slot first.`);
                  },
...
function Ir() {
  let {
    ...
    [g, v] = (0, _.useState)(``),
    [y, b] = (0, _.useState)(``),
    [x, ee] = (0, _.useState)(null),
    [S, C] = (0, _.useState)(``),
    [te, w] = (0, _.useState)(null),
    T = () => {
      if (c) {
        let e = Nr(f),
          t = 0;
        e.forEach((e) => {
          ...
          alert(`Successfully added ${t} courses from VIT-AP data format!`),
          d(!1),
          p(``);
      } else
        alert(
          `Please use the 'Add Course' button to follow the Vellore workflow.`
        );
    },
    ne = (e) => {
      e.preventDefault(),
        g.trim() &&
          (t({ code: g.toUpperCase().trim(), title: y.trim() }),
          h(!1),
          v(``),
          b(``));
    },
    ...
    ie = (e) => {
      o[e] && o[e].length > 0 ? w(e) : ee(e);
    };
  return (0, M.jsxs)(`div`, {
    className: `w-full bg-[#0f172a] text-slate-300 p-6 rounded-xl border border-slate-800 font-sans shadow-lg mb-6 relative`,
    children: [
      (0, M.jsxs)(`div`, {
        className: `flex justify-between items-center mb-6 border-b border-slate-800 pb-4`,
        children: [
          (0, M.jsxs)(`h2`, {
            className: `text-lg font-bold text-slate-100 flex items-center space-x-3`,
            children: [
              (0, M.jsx)(`span`, { children: `Course Preference` }),
              (0, M.jsxs)(`span`, {
                className: `text-xs bg-slate-800 px-2 py-1 rounded text-slate-400 font-medium ml-4 border border-slate-700`,
                children: [`Mode: `, c ? `VIT-AP (No Faculty)` : `VIT Vellore`],
              }),
            ],
          }),
          (0, M.jsxs)(`div`, {
            ...
            children: [
              (0, M.jsxs)(`button`, {
                ...
                children: [
                  (0, M.jsx)(hr, { className: `w-3.5 h-3.5 text-slate-400` }),
                  (0, M.jsxs)(`span`, {
                    children: [`Switch to `, c ? `Vellore` : `VIT-AP`],
                  }),
                ],
              }),
              (0, M.jsxs)(`button`, {
                ...
                children: [
                  (0, M.jsx)(pr, { className: `w-3.5 h-3.5` }),
                  (0, M.jsx)(`span`, { children: `View Mode` }),
                ],
              }),
              (0, M.jsxs)(`button`, {
                onClick: () => d(!0),
                className: `flex items-center space-x-2 bg-[#2d2a26] hover:bg-[#3d3933] border border-[#4a3e2f] text-orange-400 px-4 py-1.5 rounded-md text-xs font-semibold transition-colors`,
                children: [
                  (0, M.jsx)(mr, { className: `w-3.5 h-3.5` }),
                  (0, M.jsx)(`span`, { children: `Bulk Add Courses` }),
                ],
              }),
              (0, M.jsxs)(`button`, {
                onClick: () => h(!0),
                ...
                children: [
                  (0, M.jsx)(mr, { className: `w-3.5 h-3.5` }),
                  (0, M.jsx)(`span`, { children: `Add Course` }),
                ],
              }),
            ],
          }),
      ...
      (0, M.jsxs)(`div`, {
        ...
        children: [
          ...
          (!c && e.length === 0) || (c && r.length === 0)
            ? (0, M.jsx)(`div`, {
                className: `w-full bg-[#1e293b] border border-slate-800 rounded-lg p-6 flex items-center justify-center text-sm text-slate-500`,
                children: `No courses added yet. Add your first course!`,
              })
            : (0, M.jsxs)(`div`, {
                ...
                children: [
                  !c &&
                    e.map((e) => {
                      let t = o[e.code] && o[e.code].length > 0,
                        i = r.find((t) => t.code === e.code);
                      return (0, M.jsxs)(
                        `div`,
                        {
                          onClick: () => ie(e.code),
                          ...
                          } rounded-lg p-4 relative cursor-pointer hover:bg-slate-800 transition-colors`,
                          children: [
                            (0, M.jsx)(`button`, {
                              onClick: (t) => {
                                t.stopPropagation(), n(e.code);
                              },
                            ...
                            (0, M.jsx)(`div`, {
                              className: `mt-3 flex items-center space-x-2 text-xs`,
                              children: i
                                ? (0, M.jsxs)(`span`, {
                                    className: `text-green-400 flex items-center gap-1 bg-green-900/30 px-2 py-1 rounded`,
                                    children: [
                                      (0, M.jsx)(lr, {
                                ...
                                : t
                                ? (0, M.jsxs)(`span`, {
                                    className: `text-blue-400 flex items-center gap-1 bg-blue-900/30 px-2 py-1 rounded`,
                                    children: [
                                      (0, M.jsx)(yr, {
                                        className: `w-3.5 h-3.5`,
                                      }),
                                      ` Needs Faculty Selection`,
                                    ],
                                  })
                                : (0, M.jsxs)(`span`, {
                                    className: `text-red-400 flex items-center gap-1 bg-red-900/30 px-2 py-1 rounded`,
                                    children: [
                                      (0, M.jsx)(yr, {
                                        className: `w-3.5 h-3.5`,
                                      }),
                  ...
                  c &&
                    r.map((e) =>
                      (0, M.jsxs)(
                        `div`,
                        {
                          className: `bg-[#1e293b] border border-slate-700 rounded-lg p-4 relative`,
                          children: [
                            (0, M.jsx)(`button`, {
                              onClick: () => i(e.id),
                              className: `absolute top-3 right-3 text-slate-500 hover:text-red-400 transition-colors`,
                            ...
                            (0, M.jsxs)(`div`, {
                              ...
                              children: [
                                (0, M.jsx)(`span`, {
                                  className: `bg-slate-800 text-blue-400 text-xs px-2 py-0.5 rounded font-mono`,
                                  children: e.slots.join(`+`),
                                }),
                                (0, M.jsx)(`span`, {
      ...
      m &&
        (0, M.jsx)(`div`, {
          className: `absolute inset-0 bg-black/60 flex items-center justify-center z-50 rounded-xl backdrop-blur-sm`,
          children: (0, M.jsxs)(`form`, {
            onSubmit: ne,
            className: `bg-[#1e293b] p-6 rounded-xl border border-slate-700 w-full max-w-sm shadow-2xl`,
            children: [
              (0, M.jsx)(`h3`, {
              ...
              (0, M.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, M.jsx)(`button`, {
                    type: `submit`,
                    className: `bg-blue-600 hover:bg-blue-500 text-white px-4 py-2 rounded text-xs font-bold transition-colors`,
                    children: `Add`,
                  }),
                ],
              }),
      ...
      x &&
        (0, M.jsx)(`div`, {
          className: `absolute inset-0 bg-black/60 flex items-center justify-center z-50 rounded-xl backdrop-blur-sm`,
          children: (0, M.jsxs)(`div`, {
            className: `bg-[#1e293b] p-6 rounded-xl border border-slate-700 w-full max-w-lg shadow-2xl`,
            children: [
              (0, M.jsxs)(`h3`, {
                className: `text-lg font-bold text-slate-100 mb-2`,
                children: [`Parse VTOP Data for `, x],
              }),
              (0, M.jsx)(`p`, {
                className: `text-xs text-slate-400 mb-4`,
                children: `Paste the rows from VTOP's Registration table for this course.`,
              }),
              (0, M.jsx)(`textarea`, {
                value: S,
      ...
      te &&
        (0, M.jsx)(Fr, {
          courseCode: te,
          options: o[te] || [],
          selectedOptionId: r.find((e) => e.code === te)?.id,
          onConfirm: (e) => {
            let t = r.find((t) => t.code === e.code);
            t && i(t.id),
              a(e).success ? w(null) : alert(`Slot clash detected!`);
          },
          onClose: () => w(null),
        }),
      u &&
        (0, M.jsxs)(`div`, {
          className: `mb-6 bg-[#1e293b] p-4 rounded-lg border border-slate-700 mt-4`,
          children: [
            (0, M.jsx)(`h4`, {
              className: `text-sm font-bold text-slate-200 mb-2`,
              children: c
                ? `Paste Annexure II Format (Code | Title | Type | Slot)`
                : `Paste VTOP Table`,
            }),
            (0, M.jsx)(`textarea`, {
              value: f,
              ...
              placeholder: c
                ? `CHY1001	Environmental Studies	ETH	A+A1+TA+TA1
...`
            ...
            (0, M.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, M.jsx)(`button`, {
                  onClick: T,
                  className: `bg-blue-600 text-white px-4 py-1.5 rounded text-xs font-bold hover:bg-blue-500`,
                  children: `Parse & Add`,
                }),
              ],
            }),
      ...
      (0, M.jsxs)(`div`, {
        className: `flex justify-between items-center pt-4 border-t border-slate-800`,
        children: [
          ...
          (0, M.jsxs)(`div`, {
            ...
            children: [
              (0, M.jsxs)(`button`, {
                className: `flex items-center space-x-2 bg-[#2d2a26] hover:bg-[#3d3933] border border-[#4a3e2f] text-orange-400 px-4 py-1.5 rounded-md text-xs font-semibold transition-colors`,
                children: [
                  (0, M.jsx)(br, { className: `w-3.5 h-3.5` }),
                  (0, M.jsx)(`span`, { children: `Upload TT` }),
                ],
              }),
              (0, M.jsxs)(`button`, {
                className: `flex items-center space-x-2 bg-[#1e3a8a] hover:bg-blue-800 border border-blue-900 text-blue-300 px-4 py-1.5 rounded-md text-xs font-semibold transition-colors`,
                children: [
                  (0, M.jsx)(dr, { className: `w-3.5 h-3.5` }),
                  (0, M.jsx)(`span`, { children: `Save TT` }),
                ],
              }),
              (0, M.jsxs)(`button`, {
                className: `flex items-center space-x-2 bg-[#4c1d95] hover:bg-purple-800 border border-purple-900 text-purple-300 px-4 py-1.5 rounded-md text-xs font-semibold transition-colors`,
                children: [
                  (0, M.jsx)(vr, { className: `w-3.5 h-3.5` }),
                  (0, M.jsx)(`span`, { children: `Clear Selected` }),
                ],
              }),
              (0, M.jsxs)(`button`, {
                className: `flex items-center space-x-2 bg-[#7f1d1d] hover:bg-red-800 border border-red-900 text-red-300 px-4 py-1.5 rounded-md text-xs font-semibold transition-colors`,
                children: [
                  (0, M.jsx)(vr, { className: `w-3.5 h-3.5` }),
                  (0, M.jsx)(`span`, { children: `Clear All` }),
                ],
              }),
            ],
          }),
...
var Lr = [`mon`, `tue`, `wed`, `thu`, `fri`, `sat`],
  Rr = {
    mon: `MON`,
    tue: `TUE`,
    wed: `WED`,
    ...
    theory: [
      {
        ...
        days: { tue: `TFF1`, wed: `TEE1`, thu: `TG1`, fri: `TDD1` },
      },
      {
        start: `09:00`,
        end: `09:50`,
      ...
      },
      {
        ...
        days: { tue: `SC1`, wed: `SD1`, thu: `SB1`, fri: `SE1` },
      },
      {
        start: `17:00`,
        end: `17:50`,
      ...
      { start: `17:01`, end: `17:51`, days: { wed: `TE2`, fri: `TF2` } },
      {
        ...
        days: { tue: `TDD2`, wed: `TG2`, thu: `TFF2`, fri: `TEE2` },
      },
...
function Br() {
  let e = jr((e) => e.hoveredSlots),
    t = jr((e) => e.selectedCourses),
    n = `#3c8dbc`,
    r = `#ccccff`,
    i = `#99ccff`,
    a = `#e2e2e2`,
    ...
    u = { width: `50px`, minWidth: `50px` };
  return (0, M.jsx)(`div`, {
    className: `w-full h-full overflow-auto bg-white p-6`,
    children: (0, M.jsx)(`div`, {
      className: `min-w-max mx-auto shadow-sm`,
      children: (0, M.jsx)(`table`, {
        className: `w-full border-collapse`,
        style: { border: `2px solid ${n}` },
          ...
          children: [
            (0, M.jsxs)(`tr`, {
              children: [
                (0, M.jsx)(`td`, {
                  rowSpan: 2,
                  style: { ...l, backgroundColor: a, fontWeight: `bold` },
                  children: `THEORY`,
                }),
                (0, M.jsx)(`td`, {
                  style: { ...l, backgroundColor: a, fontWeight: `bold` },
                ...
                zr.theory.map((e, t) =>
                  (0, M.jsx)(
                    `td`,
                    {
                      style: { ...l, ...u, backgroundColor: r },
                      children: e.lunch ? `Lunch` : e.start,
                    },
                    `ts-${t}`
                  )
                ),
                        ...
                        zr.theory.map((r, i) => {
                          if (r.lunch)
                            return (0, M.jsx)(
                              `td`,
                              {
                                style: { ...l, ...u, backgroundColor: a },
                                children: `Lunch`,
                              },
                              `tl-${i}`
                            );
                          let d = r.days && r.days[n] ? r.days[n] : `-`,
                            f = e.includes(d),
                            p = d === `-`,
                            m = t.filter((e) => e.slots.includes(d)),
                            h = m.length > 1,
                            g = m.length > 0,
                            _ = `#ffffcc`;
                          (f || g) && (_ = o), h && (_ = `#ff0000`);
...
function Vr() {
  return (0, M.jsx)(`div`, {
    className: `flex flex-col min-h-screen bg-[#0f172a] p-8 overflow-y-auto`,
    children: (0, M.jsxs)(`div`, {
      ...
      children: [
        ...
        (0, M.jsx)(`main`, {
          children: (0, M.jsxs)(Rt, {
            children: [
              (0, M.jsx)(It, { path: `/`, element: (0, M.jsx)(xr, {}) }),
              (0, M.jsx)(It, {
                path: `/select-semester`,
                element: (0, M.jsx)(Sr, {}),
              }),
              (0, M.jsx)(It, { path: `/auth`, element: (0, M.jsx)(Mr, {}) }),
              (0, M.jsx)(It, { path: `/planner`, element: (0, M.jsx)(Vr, {}) }),
            ],
          }),
        }),
        (0, M.jsx)(Yn, {}),
...
(0, v.createRoot)(document.getElementById(`root`)).render(
  (0, M.jsx)(_.StrictMode, { children: (0, M.jsx)(Hr, {}) })
);
